...
bool loadOriginalDll() {
    ...
    if (g_originalDLL == nullptr) {
        MessageBoxW(nullptr, L"Failed to load uplay_r1_loader64.dll proxy, make sure uplay_r1_loader64_orig.dll exists on the game folder!", L"FractureLoader", MB_OK | MB_ICONERROR);
        return false;
    }

    orig_UPLAY_ACH_GetAchievements = (UPLAY_ACH_GetAchievements_t)GetProcAddress(g_originalDLL, "UPLAY_ACH_GetAchievements");
    orig_UPLAY_ACH_ReleaseAchievementList = (UPLAY_ACH_ReleaseAchievementList_t)GetProcAddress(g_originalDLL, "UPLAY_ACH_ReleaseAchievementList");
    ...
    orig_UPLAY_USER_IsInOfflineMode = (UPLAY_USER_IsInOfflineMode_t)GetProcAddress(g_originalDLL, "UPLAY_USER_IsInOfflineMode");
    orig_UPLAY_USER_IsConnected = (UPLAY_USER_IsConnected_t)GetProcAddress(g_originalDLL, "UPLAY_USER_IsConnected");
    orig_UPLAY_HasOverlappedOperationCompleted = (UPLAY_HasOverlappedOperationCompleted_t)GetProcAddress(g_originalDLL, "UPLAY_HasOverlappedOperationCompleted");
    orig_UPLAY_GetOverlappedOperationResult = (UPLAY_GetOverlappedOperationResult_t)GetProcAddress(g_originalDLL, "UPLAY_GetOverlappedOperationResult");
    orig_UPLAY_SAVE_GetSavegames = (UPLAY_SAVE_GetSavegames_t)GetProcAddress(g_originalDLL, "UPLAY_SAVE_GetSavegames");
    orig_UPLAY_SAVE_ReleaseGameList = (UPLAY_SAVE_ReleaseGameList_t)GetProcAddress(g_originalDLL, "UPLAY_SAVE_ReleaseGameList");
    ...
    orig_UPLAY_USER_GetAccountIdUtf8 = (UPLAY_USER_GetAccountIdUtf8_t)GetProcAddress(g_originalDLL, "UPLAY_USER_GetAccountIdUtf8");
    ...
    orig_UPLAY_USER_GetTicketUtf8 = (UPLAY_USER_GetTicketUtf8_t)GetProcAddress(g_originalDLL, "UPLAY_USER_GetTicketUtf8");
    ...
    orig_UPLAY_ACH_EarnAchievement = (UPLAY_ACH_EarnAchievement_t)GetProcAddress(g_originalDLL, "UPLAY_ACH_EarnAchievement");
    orig_UPLAY_OVERLAY_Show = (UPLAY_OVERLAY_Show_t)GetProcAddress(g_originalDLL, "UPLAY_OVERLAY_Show");
    orig_UPLAY_OVERLAY_SetShopUrl = (UPLAY_OVERLAY_SetShopUrl_t)GetProcAddress(g_originalDLL, "UPLAY_OVERLAY_SetShopUrl");
    orig_UPLAY_FRIENDS_GetFriendList = (UPLAY_FRIENDS_GetFriendList_t)GetProcAddress(g_originalDLL, "UPLAY_FRIENDS_GetFriendList");
    orig_UPLAY_USER_SetGameSession = (UPLAY_USER_SetGameSession_t)GetProcAddress(g_originalDLL, "UPLAY_USER_SetGameSession");
    orig_UPLAY_USER_ClearGameSession = (UPLAY_USER_ClearGameSession_t)GetProcAddress(g_originalDLL, "UPLAY_USER_ClearGameSession");
    orig_UPLAY_FRIENDS_InviteToGame = (UPLAY_FRIENDS_InviteToGame_t)GetProcAddress(g_originalDLL, "UPLAY_FRIENDS_InviteToGame");
    orig_UPLAY_PARTY_GetFullMemberList = (UPLAY_PARTY_GetFullMemberList_t)GetProcAddress(g_originalDLL, "UPLAY_PARTY_GetFullMemberList");
    ...
    orig_UPLAY_WIN_ReleaseRewardList = (UPLAY_WIN_ReleaseRewardList_t)GetProcAddress(g_originalDLL, "UPLAY_WIN_ReleaseRewardList");
    orig_UPLAY_WIN_RefreshActions = (UPLAY_WIN_RefreshActions_t)GetProcAddress(g_originalDLL, "UPLAY_WIN_RefreshActions");
    orig_UPLAY_OVERLAY_ShowShopUrl = (UPLAY_OVERLAY_ShowShopUrl_t)GetProcAddress(g_originalDLL, "UPLAY_OVERLAY_ShowShopUrl");
